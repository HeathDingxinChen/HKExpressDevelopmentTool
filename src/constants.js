...
// &_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-1w,to:now))&_q=(filters:!(),query:(language:kuery,query:''))
...

    {
        ...
        queryParam: "key:structured.message,negate:!f,params:(query:'admin%20access'),type:phrase),query:(match_phrase:(structured.message:'admin%20access')))),query:(language:kuery,query:''))",
        order: 1,
        searchAble: false,
        usedFilter: true,
        placeholder: '输入搜索关键词'
